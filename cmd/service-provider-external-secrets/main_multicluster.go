...
// runMulticluster runs the ExternalSecretsOperator service provider in the multicluster (kcp)
...
// --kcp-endpoint-slice and reconciles ExternalSecretsOperator objects in place, in every kcp
// workspace that bound the export. The provider seam (ExternalSecretsOperatorReconciler) is
// unchanged.
func runMulticluster(
	...
	utilruntime.Must(esov1alpha1.AddToScheme(scheme))
	...
	spr := serviceprovider.NewAPIReconcilerBuilder[*esov1alpha1.ExternalSecretsOperator, *esov1alpha1.ProviderConfig]().
		EmptyObjectProvider(func() *esov1alpha1.ExternalSecretsOperator { return &esov1alpha1.ExternalSecretsOperator{} }).
		EmptyConfigProvider(func() *esov1alpha1.ProviderConfig { return &esov1alpha1.ProviderConfig{} }).
