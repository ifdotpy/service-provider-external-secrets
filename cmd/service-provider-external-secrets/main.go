...
func main() {
	...
	flag.StringVar(&kcpTarget, "kcp-target", "controlplane", "Target of the service in kcp mode: 'controlplane' (object per ControlPlane) or 'workspace' (one ESO instance per enabled workspace, acting on the workspace itself).")
